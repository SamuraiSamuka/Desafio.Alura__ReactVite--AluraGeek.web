            ...
            <div className="carrinho-container container">
                ...
                <div className="carrinho">
                    <div className="carrinho__itens">
                        {
                        carrinho.length === 0 ? <div className="carrinho-vazio">
                    ...
                    carrinho.length === 0 ? "" : <div className="carrinho-resumo">
                        <Form method='post' className='carrinho-resumo__form'>
                            ...
                            {
                            formaPagamento === 'Cartão de crédito' ? <CampoInput type="select" required
                                opcoesLista={
                                    [
                                        "1x sem juros",
                                        "2x sem juros",
                            ...
                            }>Parcelas</CampoInput> : formaPagamento === "" ? <p className='carrinho__forma-pagamento-parcela'>Escolha a forma de pagamento</p> : <p className='carrinho__forma-pagamento-parcela'>Pagamento à vista</p>
                        }
                            <h4 className='carrinho__total'>Total R$ {
                                totalCarrinho.toFixed(2)
                            }</h4>
                            <Botao type="button"
                                onClick={submeteOuRedireciona}
                                disabled={
                                    carrinho.length === 0 ? "disabled" : ""
